...
Servidor <- function(input, output) {
  ...
  output$reporte <- DT::renderDataTable({
    ...
    data_original <- df_products_upload() %>% 
      ...
      mutate(Devengo_por_Salario = `1M00`+`1M82`+`1M94`+`1M01`+`1MA3`+`1M96`+`1M53`+`1M59`+`1MC1`+
               `1M72`+`1M84`+`1M78`+`1M79`+`1M58`+`1M77`+
               `1M81`+`1MA1`+`1MD7`,
             
             Devengos_Adicionales = `1M04`+`1M18`+`1M09`+`1M15`+`1M46`+`1M48`+`1MA9`+`1M43`+`1M13`+
               `1M40`+`1M14`+`1M20`+`1M11`+`1M47`+`1M10`+`1M52`+`1M34`+`1M51`+`1M16`+`1M29`+`1M98`+
  ...
  # 5. Boton para descargar el reporte -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  
  output$descargar  <- downloadHandler(
    
    filename = function(){
      paste0('Reporte-',Sys.Date(),'.csv',sep ='')
    },
    ...
    content = function(file){
      ...
      write.csv(as.data.frame(reporte),file)
    }
  )
  ...
  output$tabla3 <- DT::renderDataTable({
    ...
    estimacion_deducciones <- df_products_upload()[!duplicated(df_products_upload() %>% select(no_personal)),] %>% 
      ...
      mutate(sueldo =  salario_mensual$`9019`,
             ...
             #fecha_referencia = ymd(paste0(input$anio,"-",input$mes,"-",input$dias)),
             ...
             fecha_ultimo_decimo_cuarto = input$date2,#ymd(paste0(input$anio2,"-",input$mes2,"-",input$dias2)),
      ...
      select(no_personal,nombre,id,aguinaldo_proporcional,total_derechos_laborales,total_prestaciones,clausula_32,derechos_laborales,prestaciones,
             total_a_indemnizar,garantia_para_banrural)
    
    
    
    DT::datatable(estimacion_deducciones)
    }
  })
  
  
  # 4.7 Estimacion prestaciones y derechos laborales ------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  output$fidecomiso <- DT::renderDataTable({
    ...
    prestaciones <- df_products_upload()[!duplicated(df_products_upload() %>% select(no_personal)),] %>% 
      ...
      mutate(sueldo =  salario_mensual$`9019`,
             ...
             total_a_indemnizar = derechos_laborales + prestaciones,
             garantia_para_banrural = prestaciones + sueldo*1.25) %>% 
      select(id,nombre,no_personal,tipo_contrato,fecha_ingreso,sueldo,garantia_para_banrural,2) %>% 
    ...
    DT::datatable(prestaciones)
    }
  })
  
# 4.8 Estimacion fidecomiso -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
